		...
		function onsub() {
			...
			$.ajax({
				...
				success:function (data) {
					...
					if(data == "普通用户"){
						window.location.href="${pageContext.request.contextPath}/myAccount.jsp";
					}
					if(data =="管理员用户"){
						window.location.href="${pageContext.request.contextPath}/admin/login/home.jsp";
					}
                },
                dataType:"text"
			})
...
<body class="main">
	...
	<div id="divcontent">
		<form action="##" id="meforms" onsubmit="return false">
													...
													<tr>
														<td style="text-align:center">
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td id ="msg" style="text-align:right; padding-top:5px; width:25%"></td>
																</tr>
																<tr>
																	<td
																...
																<tr>
																	<td colspan="2" style="text-align:center"><input
																		...
																		name="checkboxs" value="checkbox" /> 自动登录</td>
																</tr>
																<tr>
																	<td colspan="2"
																		style="padding-top:10px; text-align:center"><input
																		name="image" type="image" onclick="onsub()"
