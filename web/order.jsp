    ...
    <table width="100%" border="0" cellspacing="0">
        <tr>
            ...
            <td>
                ...
                <form id="orderForm" action="${pageContext.request.contextPath}/order/orders" method="post">
                                            ...
                                            <c:forEach items="${cart}" var="entry" varStatus="vs">
                                                <table width="100%" border="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="10%"><input name="text" type="text" value="${entry.value}"
                                                                               style="width:20px" readonly="readonly"/>
                                                        </td>
                                                        <td width="10%">${entry.value * entry.key.price}</td>
                                                    </tr>
                                                    <c:set var="sum"
                                                           value="${sum + entry.value * entry.key.price}"></c:set>
                                                </table>
                                            </c:forEach>
